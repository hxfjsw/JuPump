import { MaxUint256, Token, WETH9, sqrt, Price, CurrencyAmount, Percent, currencyEquals, TradeType, Fraction, computePriceImpact, wrappedCurrencyAmount, sortedInsert, validateAndParseAddress } from '@uniswap/sdk-core';
...
var FACTORY_ADDRESS = '0xA1e393178DDFD63af56cf0BfA759A6a85606558c';
...
function wrappedCurrency(currency, chainId) {
  ...
  if (chainId === 210000) {
    var WJU = new Token(210000, '0x4d1b49b424afd7075d3c063addf97d5575e1c7e2', 18, 'WJU', 'Wrapped JU');
    return WJU;
  }
...
var Route = /*#__PURE__*/function () {
  function Route(pools, input, output) {
    ...
    var wrappedInput = wrappedCurrency$1(input, chainId);
    !pools[0].involvesToken(wrappedInput) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !pools[pools.length - 1].involvesToken(wrappedCurrency$1(output, chainId)) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    /**
  ...
  _createClass(Route, [{
    ...
    key: "inputToken",
    get: function get() {
      return wrappedCurrency$1(this.input, this.chainId);
    }
    /**
    ...
    key: "outputToken",
    get: function get() {
      return wrappedCurrency$1(this.output, this.chainId);
    }
    /**
...
var Trade = /*#__PURE__*/function () {
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_OUTPUT) {
      ...
      var slippageAdjustedAmountOut = new Fraction("1").add(slippageTolerance).invert().multiply(q).quotient;
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_INPUT) {
      ...
      var slippageAdjustedAmountIn = new Fraction("1").add(slippageTolerance).multiply(this.inputAmount.quotient).quotient;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              tokenOut = wrappedCurrency$2(currencyOut, chainId);
              i = 0;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              tokenIn = wrappedCurrency$2(currencyIn, chainId);
              i = 0;
