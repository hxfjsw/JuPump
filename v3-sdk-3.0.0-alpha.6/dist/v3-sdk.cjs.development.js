...
function wrappedCurrency(currency, chainId) {
  ...
  if (chainId === 210000) {
    var WJU = new sdkCore.Token(210000, '0x4d1b49b424afd7075d3c063addf97d5575e1c7e2', 18, 'WJU', 'Wrapped JU');
    return WJU;
  }

  if (currency.isEther) return sdkCore.WETH9[chainId];
...
var Route = /*#__PURE__*/function () {
  function Route(pools, input, output) {
    ...
    !pools[pools.length - 1].involvesToken(wrappedCurrency$1(output, chainId)) ?  invariant(false, 'OUTPUT')  : void 0;
    /**
...
var Trade = /*#__PURE__*/function () {
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === sdkCore.TradeType.EXACT_OUTPUT) {
      ...
      var q = new sdkCore.Fraction("1");

      try {
        q = new sdkCore.Fraction(this.outputAmount.quotient);
      } catch (e) {
        console.error(e);
      }

      var slippageAdjustedAmountOut = new sdkCore.Fraction("1").add(slippageTolerance).invert().multiply(q).quotient;
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === sdkCore.TradeType.EXACT_INPUT) {
      ...
      var slippageAdjustedAmountIn = new sdkCore.Fraction("1").add(slippageTolerance).multiply(this.inputAmount.quotient).quotient;
