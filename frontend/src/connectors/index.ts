...
const NETWORK_URLS: {
  ...
  //@ts-ignore
  [210000]: `https://rpc.juchain.org`,
}

//@ts-ignore
const SUPPORTED_CHAIN_IDS = [ChainId.MAINNET, ChainId.RINKEBY, ChainId.ROPSTEN, ChainId.KOVAN, ChainId.GÖRLI, 210000]

export const network = new NetworkConnector({
  urls: NETWORK_URLS,
  defaultChainId: 210000,
})
